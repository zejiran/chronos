...
export function AccountModal() {
  ...
  // OAuth state
  const [, setOauthProvider] = createSignal<"google" | "microsoft" | null>(
    null,
  );
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      if (!clientId) {
        setError(
          "Google OAuth is not configured. Please add VITE_GOOGLE_CLIENT_ID to your environment.",
        );
        setIsLoading(false);
        return;
      }
  ...
  const handleMicrosoftAuth = async () => {
    ...
    try {
      ...
      if (!clientId) {
        setError(
          "Microsoft OAuth is not configured. Please add VITE_MICROSOFT_CLIENT_ID to your environment.",
        );
        setIsLoading(false);
        return;
      }

      const { authUrl } = await startMicrosoftOAuth(
        clientId,
        clientSecret,
        redirectUri,
      );
            ...
            <Show when={step() === "google"}>
              <div class={css({ textAlign: "center" })}>
                ...
                >
                  ...
                  You'll be redirected to Google to authorize Chronos.
                </p>
                <Button
                  variant="primary"
            ...
            <Show when={step() === "microsoft"}>
              <div class={css({ textAlign: "center" })}>
                ...
                >
                  ...
                  You'll be redirected to Microsoft to authorize Chronos.
                </p>
                <Button
                  variant="primary"
            ...
            <Show when={step() === "local"}>
              <form onSubmit={handleLocalSubmit}>
                ...
                >
                  ...
                  >
                    Local calendars are stored only on this device and won't
